...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* ButtonPress service */
    {
        0x000Fu, /* Handle of the ButtonPress service */ 
        {

            /* ButtonPress characteristic */
            {
                0x0011u, /* Handle of the ButtonPress characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x0012u, /* Handle of the ButtonPressCCD descriptor */ 
                }, 
            },
        }, 
    },
