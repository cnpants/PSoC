...
#define CYBLE_BUTTONPRESS_SERVICE_INDEX   (0x00u) /* Index of ButtonPress service in the cyBle_customs array */
#define CYBLE_BUTTONPRESS_BUTTONPRESS_CHAR_INDEX   (0x00u) /* Index of ButtonPress characteristic */
#define CYBLE_BUTTONPRESS_BUTTONPRESS_BUTTONPRESSCCD_DESC_INDEX   (0x00u) /* Index of ButtonPressCCD descriptor */


#define CYBLE_BUTTONPRESS_SERVICE_HANDLE   (0x000Fu) /* Handle of ButtonPress service */
#define CYBLE_BUTTONPRESS_BUTTONPRESS_DECL_HANDLE   (0x0010u) /* Handle of ButtonPress characteristic declaration */
#define CYBLE_BUTTONPRESS_BUTTONPRESS_CHAR_HANDLE   (0x0011u) /* Handle of ButtonPress characteristic */
#define CYBLE_BUTTONPRESS_BUTTONPRESS_BUTTONPRESSCCD_DESC_HANDLE   (0x0012u) /* Handle of ButtonPressCCD descriptor */
